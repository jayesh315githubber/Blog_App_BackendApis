...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application Using Spring Boot and React",
				"This project is developed by Jayesh Gangurde", "1.0", "Terms of Service",
				new Contact("Jayesh", "-", "jayeshgangurde315@gmail.com"),
